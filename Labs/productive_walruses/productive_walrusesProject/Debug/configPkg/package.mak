...
.dlls,e674 .dlls: productive_walruses.pe674

-include package/cfg/productive_walruses_pe674.mak
-include package/cfg/productive_walruses_pe674.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/productive_walruses_pe674.dep
endif
productive_walruses.pe674: package/cfg/productive_walruses_pe674.xdl
	@


ifeq (,$(wildcard .libraries,e674))
productive_walruses.pe674 package/cfg/productive_walruses_pe674.c: .libraries,e674
endif

package/cfg/productive_walruses_pe674.c package/cfg/productive_walruses_pe674.h package/cfg/productive_walruses_pe674.xdl: override _PROG_NAME := productive_walruses.xe674
package/cfg/productive_walruses_pe674.c: package/cfg/productive_walruses_pe674.cfg
package/cfg/productive_walruses_pe674.xdc.inc: package/cfg/productive_walruses_pe674.xdl
package/cfg/productive_walruses_pe674.xdl package/cfg/productive_walruses_pe674.c: .interfaces

clean:: clean,e674
	-$(RM) package/cfg/productive_walruses_pe674.cfg
	-$(RM) package/cfg/productive_walruses_pe674.dep
	-$(RM) package/cfg/productive_walruses_pe674.c
	-$(RM) package/cfg/productive_walruses_pe674.xdc.inc

clean,e674::
	-$(RM) productive_walruses.pe674
.executables,e674 .executables: productive_walruses.xe674

productive_walruses.xe674: |productive_walruses.pe674

-include package/cfg/productive_walruses.xe674.mak
productive_walruses.xe674: package/cfg/productive_walruses_pe674.oe674 
	$(RM) $@
	@$(MSG) lnke674 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.elf.C674.rootDir)/bin/cl6x -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --abi=eabi -z  -o $@ package/cfg/productive_walruses_pe674.oe674   package/cfg/productive_walruses_pe674.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.elf.C674.rootDir)/lib/libc.a
	
productive_walruses.xe674: export C_DIR=
productive_walruses.xe674: PATH:=$(ti.targets.elf.C674.rootDir)/bin/;$(PATH)
productive_walruses.xe674: Path:=$(ti.targets.elf.C674.rootDir)/bin/;$(PATH)

productive_walruses.test test,e674 test: productive_walruses.xe674.test

productive_walruses.xe674.test:: productive_walruses.xe674
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 productive_walruses.xe674.test
else
	@$(MSG) running $<  ...
	$(call EXEC.productive_walruses.xe674, ) 
endif

clean,e674::
	-$(RM) $(wildcard .tmp,productive_walruses.xe674,*)


clean:: clean,e674

clean,e674::
	-$(RM) productive_walruses.xe674
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
productive_walruses_pe674.oe674,copy : package/cfg/productive_walruses_pe674.oe674
productive_walruses_pe674.se674,copy : package/cfg/productive_walruses_pe674.se674
