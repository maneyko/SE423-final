...
.dlls,e674 .dlls: lab8_dgnava2_maneyko2.pe674

-include package/cfg/lab8_dgnava2_maneyko2_pe674.mak
-include package/cfg/lab8_dgnava2_maneyko2_pe674.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/lab8_dgnava2_maneyko2_pe674.dep
endif
lab8_dgnava2_maneyko2.pe674: package/cfg/lab8_dgnava2_maneyko2_pe674.xdl
	@


ifeq (,$(wildcard .libraries,e674))
lab8_dgnava2_maneyko2.pe674 package/cfg/lab8_dgnava2_maneyko2_pe674.c: .libraries,e674
endif

package/cfg/lab8_dgnava2_maneyko2_pe674.c package/cfg/lab8_dgnava2_maneyko2_pe674.h package/cfg/lab8_dgnava2_maneyko2_pe674.xdl: override _PROG_NAME := lab8_dgnava2_maneyko2.xe674
package/cfg/lab8_dgnava2_maneyko2_pe674.c: package/cfg/lab8_dgnava2_maneyko2_pe674.cfg
package/cfg/lab8_dgnava2_maneyko2_pe674.xdc.inc: package/cfg/lab8_dgnava2_maneyko2_pe674.xdl
package/cfg/lab8_dgnava2_maneyko2_pe674.xdl package/cfg/lab8_dgnava2_maneyko2_pe674.c: .interfaces

clean:: clean,e674
	-$(RM) package/cfg/lab8_dgnava2_maneyko2_pe674.cfg
	-$(RM) package/cfg/lab8_dgnava2_maneyko2_pe674.dep
	-$(RM) package/cfg/lab8_dgnava2_maneyko2_pe674.c
	-$(RM) package/cfg/lab8_dgnava2_maneyko2_pe674.xdc.inc

clean,e674::
	-$(RM) lab8_dgnava2_maneyko2.pe674
.executables,e674 .executables: lab8_dgnava2_maneyko2.xe674

lab8_dgnava2_maneyko2.xe674: |lab8_dgnava2_maneyko2.pe674

-include package/cfg/lab8_dgnava2_maneyko2.xe674.mak
lab8_dgnava2_maneyko2.xe674: package/cfg/lab8_dgnava2_maneyko2_pe674.oe674 
	$(RM) $@
	@$(MSG) lnke674 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.elf.C674.rootDir)/bin/cl6x -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --abi=eabi -z  -o $@ package/cfg/lab8_dgnava2_maneyko2_pe674.oe674   package/cfg/lab8_dgnava2_maneyko2_pe674.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.elf.C674.rootDir)/lib/libc.a
	
lab8_dgnava2_maneyko2.xe674: export C_DIR=
lab8_dgnava2_maneyko2.xe674: PATH:=$(ti.targets.elf.C674.rootDir)/bin/;$(PATH)
lab8_dgnava2_maneyko2.xe674: Path:=$(ti.targets.elf.C674.rootDir)/bin/;$(PATH)

lab8_dgnava2_maneyko2.test test,e674 test: lab8_dgnava2_maneyko2.xe674.test

lab8_dgnava2_maneyko2.xe674.test:: lab8_dgnava2_maneyko2.xe674
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 lab8_dgnava2_maneyko2.xe674.test
else
	@$(MSG) running $<  ...
	$(call EXEC.lab8_dgnava2_maneyko2.xe674, ) 
endif

clean,e674::
	-$(RM) $(wildcard .tmp,lab8_dgnava2_maneyko2.xe674,*)


clean:: clean,e674

clean,e674::
	-$(RM) lab8_dgnava2_maneyko2.xe674
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
lab8_dgnava2_maneyko2_pe674.oe674,copy : package/cfg/lab8_dgnava2_maneyko2_pe674.oe674
lab8_dgnava2_maneyko2_pe674.se674,copy : package/cfg/lab8_dgnava2_maneyko2_pe674.se674
