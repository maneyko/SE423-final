...
NoError:
        ...
        PrintLine(1, "								</option>")
        PrintLine(1, "								<option id=""com.ti.ccstudio.buildDefinitions.C6000_8.2.linkerID.STACK_SIZE.1540495256"" name=""Set C system stack size (--stack_size, -stack)"" superClass=""com.ti.ccstudio.buildDefinitions.C6000_8.2.linkerID.STACK_SIZE"" value=""0x2000"" valueType=""string""/>")
        ...
        PrintLine(1, "							</tool>")
        PrintLine(1, "							<tool commandLinePattern=""${command} ${flags} &quot;..\..\..\..\LabFiles\SYSBIOShex\out2bootbin.cmd&quot; ${output_flag} ${output} ${inputs}"" id=""com.ti.ccstudio.buildDefinitions.C6000_8.2.hex.222047851"" name=""C6000 Hex Utility"" superClass=""com.ti.ccstudio.buildDefinitions.C6000_8.2.hex"">")
